      ...
      <div className="flex flex-col lg:flex-row items-start lg:items-center gap-8 w-full">
        ...
        <div className="flex-1 space-y-4 w-full lg:w-auto">
          ...
          {userCVR < B2B_AVERAGE && (
            <div className="rounded-lg p-6" style={{ backgroundColor: '#FFF0F5', border: `2px solid ${AVG_COLOR}` }}>
              ...
              <div className="flex flex-wrap gap-2">
                <div className="px-4 py-2 rounded-full font-semibold whitespace-nowrap" style={{ backgroundColor: '#B656A6', color: 'white' }}>
          ...
          <div className="rounded-lg p-6" style={{ backgroundColor: '#F0FFFC', border: `2px solid ${TOP_25_COLOR}` }}>
            ...
            <div className="flex flex-wrap gap-2">
              <div className="px-4 py-2 rounded-full font-semibold whitespace-nowrap" style={{ backgroundColor: '#05AB80', color: 'white' }}>
